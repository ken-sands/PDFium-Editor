...
namespace PdfiumEditor
{
    internal static class NativeMethods
    {
        ...
        [DllImport("pdfium.dll")]
        unsafe public static extern void FPDFPageObj_GetBBox(IntPtr pageObject, float* left, float* bottom, float* right, float* top);

        [DllImport("pdfium.dll")]
        public static extern void FPDFPageObj_TransformRect(IntPtr page, double left, double top, double right, double bottom,
    ...
    //FPDF_PAGEOBJ_TEXT     1
 	...
 	//FPDF_PAGEOBJ_FORM     5
        ...
        [DllImport("pdfium.dll")]
        public static extern int FPDFPageObj_GetObjectType(IntPtr pageObject);
        ...
        [DllImport("pdfium.dll")]
        public static extern IntPtr FPDF_LoadPage(IntPtr document, int page_index);  //returns FPDF_PAGE object

        [DllImport("pdfium.dll")]
        unsafe public static extern int FPDF_ImportPages(IntPtr document, IntPtr src_document, char* pagerange, int index);		

        [DllImport("pdfium.dll")]
        public static extern IntPtr FPDFText_LoadPage(IntPtr page);

        [DllImport("pdfium.dll")]
        unsafe public static extern int FPDFText_GetBoundedText(IntPtr text_page, double left, double top, double right, double bottom, ushort * buffer, int buflen);

        [DllImport("pdfium.dll")]
        unsafe public static extern int FPDFText_GetBoundedText2(IntPtr text_page, double left, double top, double right, double bottom, ushort* buffer, int buflen, double tolerance);

        [DllImport("pdfium.dll")]
        public static extern bool FPDF_SaveToFile(IntPtr document, StringBuilder path, uint flags);
       ...
       // public static extern void FORM_OnAfterLoadPage(IntPtr page, IntPtr _form);
        ...
        [DllImport("pdfium.dll")]
        public static extern double FPDF_GetFileVersion(IntPtr document, ref int pdfver);
        ...
        [DllImport("pdfium.dll")]
        public static extern bool FPDFImageObj_SetMatrix(IntPtr image_object, double a, double b, double c, double d, double e, double f);

        [DllImport("pdfium.dll")]
        public static extern IntPtr FPDFBitmap_Create(int width, int height, int alpha);

        [DllImport("pdfium.dll")]
        unsafe public static extern void* FPDFBitmap_GetBuffer(IntPtr bitmap);

        [DllImport("pdfium.dll")]
        unsafe public static extern bool FPDFImageObj_SetBitmap(IntPtr page, int nCount, IntPtr image_object, IntPtr bitmap);
