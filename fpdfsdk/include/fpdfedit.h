...
// Function: FPDFPageObj_GetObjectType
//			Returns the pageobject type
// Parameters:	
...
//			Returns the bonding box of the object passed (tested for images)
// Parameters:	
//			pageObject	-	Handle to a page object.
// Return value:
//			left bottom right and top are filled in, assuming bottom left origin but may need to check the pdf to adjust
...
// Function: FPDFPageObj_TransformRect
//			Transform (scale, rotate, shear, move) all page objects within rectangle.
